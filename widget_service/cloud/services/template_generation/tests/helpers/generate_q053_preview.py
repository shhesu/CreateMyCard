"""从 Q053 输入经正式检索、规划、编译生成本地预览，不调用模型。"""
...
TEMPLATE_ID = "BluetoothDeviceOverviewEarbudChargingWideFull@1"
...
def generate(source: Path, output: Path) -> None:
    ...
    print("Q053 matched; WideFullOnlyLayout + embedded favorite action compiled")
