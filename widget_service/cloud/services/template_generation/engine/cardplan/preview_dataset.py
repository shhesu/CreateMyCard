...
_TEXT_BY_TEMPLATE_PARAMETER = {
    ...
    ("GenericMetricOverviewWideSupport@1", "title"): "步数",
    ("GenericMetricOverviewWideSupport@1", "valuePath"): "/dailySteps",
    ...
    ("GenericMetricOverviewDualWideSupport@1", "firstTitle"): "步数",
    ("GenericMetricOverviewDualWideSupport@1", "firstValuePath"): "/dailySteps",
    ("GenericMetricOverviewDualWideSupport@1", "secondTitle"): "平均心率",
    ("GenericMetricOverviewDualWideSupport@1", "secondValuePath"): "/exerciseHeartRateAvg",
